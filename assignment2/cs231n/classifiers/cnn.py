...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['b1'] = np.zeros((1,F))
        self.params['W2'] = weight_scale * np.random.randn(H*W*F//4, hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        da2, dW3, db3 = affine_backward(dscores, cache)
        da1, dW2, db2 = affine_relu_backward(da2, a2_cache)
        dX, dW1, db1 = conv_relu_pool_backward(da1, a1_cache)
